...
\restrict uzrm2BdCnc74nuRJGVOOqYHXlgftPYWRRKOa7jIg9glNWBjWpQPg9czVgQauQpP

-- Dumped from database version 18.4
-- Dumped by pg_dump version 18.4

-- Started on 2026-07-23 15:02:32
...
--
-- TOC entry 6 (class 2615 OID 18121)
...
--
-- TOC entry 237 (class 1259 OID 18199)
-- Name: bridge_program_genre; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.bridge_program_genre OWNER TO postgres;

--
-- TOC entry 230 (class 1259 OID 18150)
-- Name: dim_channel; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.dim_channel OWNER TO postgres;

--
-- TOC entry 229 (class 1259 OID 18149)
-- Name: dim_channel_channel_key_seq; Type: SEQUENCE; Schema: warehouse; Owner: postgres
--

ALTER TABLE warehouse.dim_channel ALTER COLUMN channel_key ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME warehouse.dim_channel_channel_key_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 227 (class 1259 OID 18122)
...
-- Name: dim_episode; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.dim_episode OWNER TO postgres;

--
-- TOC entry 233 (class 1259 OID 18174)
-- Name: dim_episode_episode_key_seq; Type: SEQUENCE; Schema: warehouse; Owner: postgres
--

ALTER TABLE warehouse.dim_episode ALTER COLUMN episode_key ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME warehouse.dim_episode_episode_key_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 236 (class 1259 OID 18189)
-- Name: dim_genre; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.dim_genre OWNER TO postgres;

--
-- TOC entry 235 (class 1259 OID 18188)
-- Name: dim_genre_genre_key_seq; Type: SEQUENCE; Schema: warehouse; Owner: postgres
--

ALTER TABLE warehouse.dim_genre ALTER COLUMN genre_key ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME warehouse.dim_genre_genre_key_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 232 (class 1259 OID 18161)
-- Name: dim_program; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.dim_program OWNER TO postgres;

--
-- TOC entry 231 (class 1259 OID 18160)
-- Name: dim_program_program_key_seq; Type: SEQUENCE; Schema: warehouse; Owner: postgres
--

ALTER TABLE warehouse.dim_program ALTER COLUMN program_key ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME warehouse.dim_program_program_key_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: dim_time; Type: TABLE; Schema: warehouse; Owner: postgres
--
...
ALTER TABLE warehouse.dim_time OWNER TO postgres;

--
-- TOC entry 239 (class 1259 OID 18217)
-- Name: fact_broadcast; Type: TABLE; Schema: warehouse; Owner: postgres
--

CREATE TABLE warehouse.fact_broadcast (
    broadcast_key bigint NOT NULL,
    date_key integer NOT NULL,
    ...
    broadcast_count integer DEFAULT 1 NOT NULL,
    is_live boolean NOT NULL,
    is_new boolean NOT NULL,
    CONSTRAINT fact_broadcast_broadcast_count_check CHECK ((broadcast_count = 1)),
    CONSTRAINT fact_broadcast_duration_minutes_check CHECK ((duration_minutes > 0))
);


ALTER TABLE warehouse.fact_broadcast OWNER TO postgres;

--
-- TOC entry 238 (class 1259 OID 18216)
-- Name: fact_broadcast_broadcast_key_seq; Type: SEQUENCE; Schema: warehouse; Owner: postgres
--

ALTER TABLE warehouse.fact_broadcast ALTER COLUMN broadcast_key ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME warehouse.fact_broadcast_broadcast_key_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 5163 (class 0 OID 18082)
-- Dependencies: 226
...
--
-- TOC entry 5162 (class 0 OID 18063)
-- Dependencies: 225
...
--
-- TOC entry 5160 (class 0 OID 18036)
-- Dependencies: 223
...
--
-- TOC entry 5161 (class 0 OID 18046)
-- Dependencies: 224
...
--
-- TOC entry 5157 (class 0 OID 17998)
-- Dependencies: 220
...
--
-- TOC entry 5158 (class 0 OID 18008)
-- Dependencies: 221
...
--
-- TOC entry 5159 (class 0 OID 18018)
-- Dependencies: 222
...
--
-- TOC entry 5174 (class 0 OID 18199)
-- Dependencies: 237
-- Data for Name: bridge_program_genre; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.bridge_program_genre (program_key, genre_key) FROM stdin;
120	1
118	1
118	2
271	3
...
--
-- TOC entry 5167 (class 0 OID 18150)
-- Dependencies: 230
-- Data for Name: dim_channel; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_channel (channel_key, source_channel_id, call_sign) FROM stdin;
1	1	ABC
2	2	CBS
3	3	FOX
4	4	NBC
...
--
-- TOC entry 5164 (class 0 OID 18122)
-- Dependencies: 227
-- Data for Name: dim_date; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_date (date_key, full_date, day_number, month_number, month_name, quarter_number, year_number, day_name) FROM stdin;
20260723	2026-07-23	23	7	July	3	2026	Thursday
\.


--
-- TOC entry 5171 (class 0 OID 18175)
-- Dependencies: 234
-- Data for Name: dim_episode; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_episode (episode_key, source_episode_id, season_number, episode_number, episode_title) FROM stdin;
1	1	22	2	Ballad of Dwight and Irena
2	2	1	9	McLaren P1
3	3	1	7	Hilux Australia
4	4	1	5	Ford Xr8 Australia
5	5	2	1	Fighting Fox: Road to Hell
6	6	2	3	The Magnificent Bastards of Dai Do
7	7	1	2	Escape From Moscow
8	8	1	1	Old Acquaintances
9	9	1	2	Who's There?
10	10	14	9	Legends and Rookies
11	11	6	10	Paranormal Cat- tivity
12	12	6	18	Lauren
13	13	6	19	With Friends Like These...
14	14	6	20	Hanley Waters
15	15	2	11	Too Much Soul Food
16	16	2	12	Super Face-Off
17	17	2	13	Soul Mate to Cellmate
18	18	10	3	All Lumped Together
19	19	4	16	Golden Oldie
20	20	4	17	Big Thanks Little Thanks
21	21	4	18	Super Senior
22	22	1	10	Lucky Girl
23	23	2	2	Down and Outing
24	24	3	3	It's Greek to Me-ow
25	25	3	5	Landing Stripling
26	26	3	6	Calypso Cat
27	27	2	8	Dicky Moe
28	28	1	116	Too Weak to Work
29	29	11	5	Ration Fer the Duration
30	30	23	121	Kristen Doute & Ariana Biermann
31	31	7	174	Season 7 Episode 174
32	32	19	7	Beyond the Alcove or: How I Learned to Stop Worrying and Love Klaus
33	33	19	8	A Song of Knives and Fire
34	34	9	9	Salute Your Morts
35	35	3	3	Pickle Rick
36	36	2	10	Love, Rose
37	37	2	3	'Hot' Chocolate
38	38	2	4	Macaron Stackaron
39	39	1	5	The Night Shift
40	40	2	8	Ice Cold in Denver
41	41	2	15	Friday Night Ghosts
42	42	3	5	Doctors, Divas and 2 Worthless Nuts
43	43	3	6	The Grand Porkin' Finale
44	44	27	2	Cozying Up to a House on the Canal in Jamaica Beach
45	45	8	2	Searching for America's Lost Flight
46	46	12	7	Charles' Journey
47	47	8	1	John & Lonnie's Story
48	48	3	2	Boss Life; Papaganda
49	49	3	3	Little Buddy; Zen Garden
50	50	3	4	No Service; Takened
51	51	1	15	Mall Leader; Ghost Wolf's Art
52	52	5	13	Chef Goofy on the Go!
53	53	5	7	Mickey's Mousekeball
54	54	3	1	The Hyper-potamus Pizza-Party-torium
55	55	2	17	What Ever Happened to Donald Duck?!
56	56	2	19	A Nightmare on Killmotor Hill
57	57	1	16	Family Fishing Trip; Bizarre Bazaar
58	58	41	4	Food Family Takeover
59	59	38	4	Masters of Cheese
60	60	39	11	Super Spicy Games
61	61	60	145	Season 60 Episode 145
62	62	12	11	Trans-Fascism
63	63	12	12	Three Men and a Bastard
64	64	12	13	Accidental Terrorist
65	65	1	4	Flushed in West Milford
66	66	1	3	Hasbrouck Heights Duplex Delights
67	67	1	2	Flips Ahoy in South Amboy
68	68	37	18	Episode #37.18
69	69	23	83	Episode #23.83
70	70	23	85	Episode #23.85
71	71	5	17	The Career Girl
72	72	5	18	The Hero
73	73	5	19	The Inferno
74	74	5	4	The Silent Bell
75	75	5	5	The Reunion
76	76	8	19	Day of the Dead
77	77	8	20	Angel of Death
78	78	8	15	Tinker, Tailor, Liar, Thief
79	79	2	6	From Scary to Stunning
80	80	13	6	Thin Margins
81	81	1	8	Supersized Deadfall Trap
82	82	4	14	The Reverend Steps Out
83	83	4	15	Larry Loves Janet
84	84	4	16	Mighty Mouth
85	85	4	17	The Love Lesson
86	86	10	14	Cul-de-sac
87	87	6	5	Risking it All
88	88	1	5	View to a Rampage
89	89	5	18	Family Matters
90	90	6	1	The Platform
91	91	4	6	Float Your Boat
92	92	4	7	Dragazines
93	93	4	8	Frenemies
94	94	5	1	A Dream Come True
95	95	10	2	The Russell Cabin's Big Lift
96	96	16	5	Small Town, Big Dreams
97	97	7	9	Chanel and Sterling XXII
98	98	23	23	Chanel and Sterling CCCXCV
99	99	48	6	Matthew Mounce
100	100	6	21	I, Stank Hole in One
101	101	4	8	I Was En Vogue's Love Slave
102	102	4	9	Can I Get a Witness?
103	103	4	10	Ted's Revenge
104	104	1	2	Rome's Sunken Secrets
105	105	1	4	Nero's Lost Palace
106	106	1	1	Hidden Secrets of Pompeii
107	107	1	6	Sharks Gone Rogue
108	108	2	20	The World of North America
109	109	1	23	The One with the Birth
110	110	1	24	The One Where Rachel Finds Out
111	111	2	1	The One with Ross' New Girlfriend
112	112	4	23	Pups Save Luke Stars; Pups Save Chicken Day
113	113	3	9	Pups Save a Dragon; Pups Save the Three Little Pigs
114	114	4	22	Sea Patrol: Pups Save a Frozen Flounder; Sea Patrol: Pups Save a Narwhal
115	115	4	22	Sea Patrol: Pups Save a Frozen Flounder; Sea Patrol: Pups Save a Narwhal
116	116	2	21	The Crew Builds a Winter Wonderland; Crew Builds a Giant Snow Squirrely Whirly
117	117	4	10	Mission PAW: Pups Save the Royal Throne
118	118	2	27	Pre-Hibernation Week; Life of Crime
119	119	15	2	UpWard; Unidentified Flailing Octopus
120	120	2	21	Your Shoe's Untied; Squid's Day Off
121	121	6	7	Giant Squidward; No Nose Knows
122	122	2	2	Fashion
123	123	7	3	Some Like It Hotter
124	124	7	5	Fort Worth Fortune
125	125	7	7	Delaware Dream Home
126	126	10	7	Close-Knit Clan
127	127	6	5	Sacrifice
128	128	6	6	Unforeseen
129	129	6	7	Behind the Veil
130	130	4	82	Armed Carjacker
131	131	6	7	Blaze of Winston-Salem
132	132	13	7	Terror in Paradise
133	133	3	2	Attack Over Baghdad
134	134	9	10	Hate
135	135	9	11	Ramparts
136	136	5	22	If I Had a Quarter-Million
137	137	2	17	Personal
138	138	2	18	Harm's Way
139	139	6	10	Murder
140	140	6	11	Shareholder Meeting
141	141	6	12	Scott's Tots
142	142	6	13	Secret Santa
143	143	5	26	Appetite for Destruction; Frame on You
144	144	6	4	The Taunting Hour; Musical Chairs
145	145	5	24	Fright Bite; The Loudly Bones
146	146	6	3	Ew! What Is That?
147	147	2	3	She's All MILF
148	148	4	4	Baby Blues
149	149	4	5	Saving Sammy
150	150	4	6	Static
151	151	10	1	The Haunted Pub of Doncaster and More
152	152	9	8	Bigfoot in Great Britain and More!
153	153	10	2	A Spirited Infirmary in Indiana and More
154	154	1	153	The Alliance
155	155	1	155	Sorry for Your Loss
156	156	4	21	The Smelly Car
157	157	4	22	The Handicap Spot
158	158	5	1	The Mango
159	159	5	9	Comedy of Errors
160	160	1	10	The Pineapple Incident
161	161	6	3	Skylar Diggins; Vic Mensa
162	162	6	4	Bow Wow; Que
163	163	6	5	Chrissy Teigen; PWD
164	164	6	6	Austin Mahone
165	165	2	5	S.O.S.
166	166	2	6	Never Again
167	167	1	2	Healing Takes Time
168	168	4	22	Hurricane Hampered
169	169	5	9	Burned in a Blackout
170	170	2	2	The Galveston Hurricane of 1900
171	171	3	5	Unbowed and Unbent
172	172	3	5	Unbowed and Unbent
173	173	2	8	International Assassin
174	174	2	9	Ten Thirteen
175	175	2	10	I Live Here Now
\.


--
-- TOC entry 5173 (class 0 OID 18189)
-- Dependencies: 236
-- Data for Name: dim_genre; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_genre (genre_key, source_genre_id, genre_name) FROM stdin;
1	1	News
2	2	Sport
3	3	Crime
4	4	Mystery
...
--
-- TOC entry 5169 (class 0 OID 18161)
-- Dependencies: 232
-- Data for Name: dim_program; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_program (program_key, source_program_id, title, program_type, parental_rating) FROM stdin;
1	276	Audrey Rose	movie	PG
2	275	The Keep	movie	R
3	274	LaRoy, Texas	movie	\N
4	273	Boo! A Madea Halloween	movie	PG-13
5	272	The Legend of Bagger Vance	movie	PG-13
6	271	There's Something Wrong with the Children	movie	TV-MA
7	270	A House on the Bayou	movie	TV-MA
8	268	Don Ricardo Returns	movie	\N
9	267	Shotgun	movie	\N
10	266	Big Eyes	movie	G
11	264	Marshall	movie	G
12	263	The Hunting Party	movie	R
13	262	High Ground	movie	TV-14
14	261	The Day	movie	R
15	259	Transit	movie	R
16	258	The Woman in Green	movie	PG
17	257	What's Cooking?	movie	PG-13
18	256	Joey and Ella	movie	G
19	254	The Hard Hit	movie	\N
20	253	The Strangers: Chapter 3	movie	R
21	252	Beautiful Wave	movie	PG-13
22	251	My Dog the Champion	movie	G
23	250	Dreams	movie	\N
24	249	Fairhaven	movie	\N
25	248	Crave	movie	R
26	247	The Queen of Spain	movie	\N
27	246	Hi-Life	movie	R
28	244	Rememory	movie	PG-13
29	243	Escape From Pretoria	movie	PG-13
30	242	Van Helsing	movie	PG-13
31	241	The Man in the White Van	movie	PG-13
32	239	The Beldham	movie	\N
33	238	Black Lotus	movie	\N
34	237	Terms of Endearment	movie	PG
35	236	Raiders of the Lost Ark	movie	G
36	235	Lara Croft: Tomb Raider	movie	TV-14
37	234	Scream 3	movie	R
38	233	All the World is Sleeping	movie	\N
39	231	Day of the Fight	movie	R
40	230	South Park: Bigger, Longer & Uncut	movie	R
41	228	Failure to Launch	movie	PG-13
42	227	Good Burger	movie	PG
43	225	Queen Bees	movie	PG-13
44	224	Orange County	movie	PG-13
45	222	Pootie Tang	movie	R
46	221	The Comeback Trail	movie	R
47	220	THE RESURGENCE: DeMarcus Cousins	movie	R
48	219	Undisputed	movie	R
49	218	Not Without Hope	movie	R
50	217	Daniela Forever	movie	R
51	216	Scream 4	movie	R
52	214	Y2K	movie	TV-14
53	213	Shot Caller	movie	R
54	212	Final Destination 5	movie	R
55	211	Happy Death Day	movie	PG-13
56	210	Body At Brighton Rock	movie	R
57	209	Heretic	movie	R
58	208	Pirate Radio	movie	R
59	207	Son of Godzilla	movie	\N
60	205	The Long Walk	movie	R
61	204	Eddington	movie	R
62	202	Mickey 17	movie	\N
63	201	House of the Dragon	movie	\N
64	200	Deadpool 2	movie	R
65	181	Fiddler on the Roof	movie	PG
66	170	F9	movie	G
67	148	Paid Program	movie	G
68	147	Yoga Teacher Killer: The Kaitlin Armstrong Story	movie	TV-14
69	130	Christmas on Candy Cane Lane	movie	TV-PG
70	129	A Royal Icing Christmas	movie	\N
71	127	Carousel	movie	G
72	126	Big George Foreman: The Miraculous Story of the Once and Future Heavyweight	movie	PG-13
73	124	Man on Fire	movie	R
74	120	Arranged Love	movie	\N
75	119	Royal Rendezvous	movie	\N
76	60	Malibooty!	movie	PG-13
77	76	Courtside	sports	\N
78	75	The Paul Finebaum Show	sports	\N
79	74	SEC Now	sports	\N
80	68	The Association	sports	\N
81	67	Quick Pitch	sports	\N
82	65	The Insiders	sports	\N
83	64	Team Highlights	sports	\N
84	61	Golf Central	sports	\N
85	59	2026 FIFA World Cup	sports	\N
86	57	The Basketball Tournament	sports	\N
87	56	Live Racing! International	sports	\N
88	55	College Football	sports	\N
89	54	BBA Bubbleball	sports	\N
90	53	Donk Toss World Championship	sports	\N
91	51	MLB Baseball	sports	\N
92	49	The 2026 ESPYS	sports	\N
93	48	SportsCenter	sports	\N
94	46	2026 SBD World's Strongest Man	sports	\N
95	44	College Baseball	sports	\N
96	43	Authentic ACC	sports	\N
97	42	ACC Huddle	sports	\N
98	183	The Loud House	family	TV-Y7
99	163	SpongeBob SquarePants	family	TV-Y7
100	161	Rubble & Crew	family	TV-Y
101	160	PAW Patrol	family	TV-Y
102	118	Amphibia	family	TV-Y7
103	117	DuckTales	family	TV-Y7
104	115	Bluey	family	TV-Y
105	114	Disney's Mickey Mouse Clubhouse	family	TV-Y
106	111	Kiff	family	TV-Y7
107	110	Big City Greens	family	TV-Y7
108	40	On Balance with Leland Vittert	news	\N
109	39	Cuomo	news	\N
110	37	The Briefing with Jen Psaki	news	\N
111	36	All in with Chris Hayes	news	TV-PG
112	28	U.S. House of Representatives	news	\N
113	27	Anderson Cooper 360°	news	\N
114	26	CNN NewsNight with Abby Phillip	news	\N
115	20	BBC News	news	\N
116	14	La mesa caliente	news	\N
117	13	En casa con Telemundo	news	\N
118	5	Early Today	news	\N
119	2	CBS News Roundup	news	\N
120	1	ABC World News Now	news	\N
121	269	The Westies	other	\N
122	265	Macbeth	other	R
123	260	The Grudge 2	other	PG-13
124	255	Girl in Progress	other	PG-13
125	245	High School	other	R
126	240	Bait	other	R
127	232	Would You Rather	other	\N
128	229	Virtuosity	other	\N
129	226	Everybody Wants Some!!	other	R
130	223	Star Trek: Insurrection	other	G
131	215	Faster	other	\N
132	206	Godzilla vs. Gigan	other	PG
133	203	The Leftovers	other	TV-MA
134	199	Warfare	other	\N
135	198	Life, Larry and the Pursuit of Unhappiness	other	TV-MA
136	197	House of the Dragon	other	TV-MA
137	196	When Weather Changed History	other	\N
138	195	Storm of Suspicion	other	\N
139	194	The Braxtons	other	TV-14
140	193	S.W.A.T.	other	TV-14
141	192	QAnon: The Search for Q	other	TV-14
142	191	Nick Cannon Presents: Wild 'N Out	other	TV-14
143	190	How I Met Your Mother	other	TV-PG
144	189	Seinfeld	other	TV-PG
145	188	Impractical Jokers: Inside Jokes	other	TV-14
146	187	Paranormal Caught on Camera	other	TV-PG
147	186	Cold Case	other	TV-14
148	185	MILF Manor	other	TV-14
149	184	Save My Skin	other	\N
150	182	The Loud House	other	TV-Y7
151	180	The Office	other	TV-14
152	179	NCIS: Los Angeles	other	TV-14
153	178	Cocaine Bear	other	R
154	177	The Andy Griffith Show	other	\N
155	176	Law & Order	other	TV-14
156	175	Mayday: Air Disaster	other	TV-14
157	174	Secret Nazi Ruins	other	TV-PG
158	173	Engineering Catastrophes	other	TV-PG
159	172	On Patrol: Live	other	TV-14
160	171	FBI	other	TV-14
161	169	The Killer Among Us	other	\N
162	168	Love It or List It	other	\N
163	167	My Lottery Dream Home	other	\N
164	166	The Aging Brain	other	G
165	165	Have Thinning Hair? Keranique Can Help Regrow Beautiful, Thicker Hair!	other	\N
166	164	The Art Of	other	TV-14
167	162	SpongeBob SquarePants	other	TV-Y7
168	159	PAW Patrol	other	TV-Y
169	158	Friends	other	TV-14
170	157	Jack Hanna's Passport	other	\N
171	156	Shark Attack Files	other	TV-14
172	155	Lost Treasures of Rome	other	TV-PG
173	154	The Wayans Bros.	other	TV-PG
174	153	The Fresh Prince of Bel-Air	other	TV-PG
175	152	Ridiculousness	other	TV-14
176	151	Barnwood Builders	other	\N
177	150	Maine Cabin Masters	other	\N
178	149	RuPaul's Drag Race	other	TV-14
179	146	Rizzoli & Isles	other	TV-14
180	145	Body Cam	other	TV-14
181	144	See No Evil	other	TV-14
182	143	Three's Company	other	TV-PG
183	142	Alone: The Skills Challenge	other	TV-PG
184	141	Alone	other	TV-14
185	140	Scariest House in America	other	\N
186	139	Ugliest House in America	other	\N
187	138	House Hunters	other	\N
188	137	Murder, She Wrote	other	TV-PG
189	136	Highway to Heaven	other	TV-PG
190	135	Heartland	other	TV-PG
191	134	The Waltons	other	\N
192	133	Bath Makeover	other	G
193	132	Family Feud	other	TV-PG
194	131	Jeopardy!	other	\N
195	128	24 Hour Flip	other	TV-PG
196	125	King of the Hill	other	TV-PG
197	123	The 700 Club	other	\N
198	122	What’s Your Injury Case Worth?	other	G
199	121	Guy's Grocery Games	other	\N
200	116	Big Hero 6	other	TV-Y7
201	113	Disney's Mickey Mouse Clubhouse	other	TV-Y
202	112	BeddyByes	other	\N
203	109	Big City Greens	other	TV-Y7
204	108	My 600-lb Life	other	TV-PG
205	107	Kitchen Crashers	other	\N
206	106	Bakery Boss	other	TV-PG
207	105	Food Paradise	other	\N
208	104	Hustlers Gamblers Crooks	other	\N
209	103	Expedition Unknown	other	TV-PG
210	102	Beachfront Bargain Hunt	other	\N
211	101	BBQ Pitmasters	other	TV-PG
212	100	Cold Case Files	other	TV-14
213	99	Kids Baking Championship	other	\N
214	98	South Park	other	TV-MA
215	97	CMT Music	other	TV-PG
216	96	The Golden Girls	other	TV-PG
217	95	Rick and Morty	other	TV-14
218	94	American Dad!	other	TV-14
219	93	The Kelly Clarkson Show	other	\N
220	92	Watch What Happens: Live	other	TV-14
221	91	Next Gen NYC	other	\N
222	90	Popeye the Sailor	other	PG
223	89	Tom and Jerry	other	TV-PG
224	88	Ben 10	other	TV-Y7
225	87	Reminisce	other	TV-14
226	86	Tyler Perry's Assisted Living	other	TV-PG
227	85	Tyler Perry's House of Payne	other	TV-PG
228	84	The Jamie Foxx Show	other	TV-PG
229	83	Criminal Minds	other	TV-14
230	82	My Cat from Hell	other	TV-PG
231	81	Naked and Afraid	other	TV-14
232	80	The Walking Dead: Dead City	other	TV-MA
233	79	Shadow Ops	other	TV-PG
234	78	Against the Odds	other	TV-PG
235	77	Swamp Patrol	other	\N
236	73	Shooting USA	other	\N
237	72	Handguns	other	\N
238	71	Guns & Ammo TV	other	\N
239	70	Bowhunter TV	other	\N
240	69	NHL Tonight	other	\N
241	66	Quick Pitch	other	\N
242	63	Team Highlights	other	\N
243	62	Wheeler Dealers: World Tour	other	\N
244	58	2026 FIFA World Cup	other	\N
245	52	Pardon the Interruption	other	\N
246	50	NFL Live	other	\N
247	47	SportsCenter	other	\N
248	45	2026 SBD World's Strongest Man	other	\N
249	41	College Football	other	\N
250	38	Katie Pavlich	other	TV-PG
251	35	The 11th Hour with Ali Velshi	other	\N
252	34	Forensic Files	other	TV-14
253	33	Fox News @ Night	other	\N
254	32	Gutfeld!	other	\N
255	31	Hannity	other	\N
256	30	Kelsey Grammer's Historic Battles for America	other	\N
257	29	Best Mattress Topper Ever!	other	G
258	25	Anderson Cooper 360°	other	\N
259	24	Squawk Box (Europe)	other	\N
260	23	Dateline	other	TV-14
261	22	The Pulse with Francine Lacqua	other	\N
262	21	Bloomberg: The Opening Trade	other	\N
263	19	Talking Movies	other	TV-PG
264	18	Business Today	other	\N
265	17	Vecinos	other	TV-PG
266	16	Desiguales	other	\N
267	15	Como dice el dicho	other	TV-14
268	12	En casa con Telemundo	other	\N
269	11	Paid Program	other	G
270	10	Inogen Portable Oxygen - No More Tanks!	other	\N
271	9	Law & Order: Special Victims Unit	other	TV-14
272	8	Once Upon a Time in Space	other	\N
273	7	Breaking the Deadlock	other	\N
274	6	Bugs That Rule the World	other	\N
275	4	Top Story with Tom Llamas	other	\N
276	3	Local Programs	other	TV-14
\.


--
-- TOC entry 5165 (class 0 OID 18137)
-- Dependencies: 228
-- Data for Name: dim_time; Type: TABLE DATA; Schema: warehouse; Owner: postgres
--

COPY warehouse.dim_time (time_key, full_time, hour_number, minute_number, second_number) FROM stdin;
140100	14:01:00	14	1	0
180000	18:00:00	18	0	0
152500	15:25:00	15	25	0
152200	15:22:00	15	22	0
151600	15:16:00	15	16	0
131300	13:13:00	13	13	0
142800	14:28:00	14	28	0
140700	14:07:00	14	7	0
151700	15:17:00	15	17	0
162600	16:26:00	16	26	0
143000	14:30:00	14	30	0
141300	14:13:00	14	13	0
151000	15:10:00	15	10	0
130000	13:00:00	13	0	0
121400	12:14:00	12	14	0
113100	11:31:00	11	31	0
80000	08:00:00	8	0	0
164200	16:42:00	16	42	0
110000	11:00:00	11	0	0
141700	14:17:00	14	17	0
132300	13:23:00	13	23	0
145000	14:50:00	14	50	0
144400	14:44:00	14	44	0
171500	17:15:00	17	15	0
170600	17:06:00	17	6	0
124700	12:47:00	12	47	0
153200	15:32:00	15	32	0
133100	13:31:00	13	31	0
150600	15:06:00	15	6	0
163500	16:35:00	16	35	0
134500	13:45:00	13	45	0
144200	14:42:00	14	42	0
143600	14:36:00	14	36	0
161500	16:15:00	16	15	0
135000	13:50:00	13	50	0
150200	15:02:00	15	2	0
173600	17:36:00	17	36	0
164800	16:48:00	16	48	0
133600	13:36:00	13	36	0
145500	14:55:00	14	55	0
154900	15:49:00	15	49	0
121600	12:16:00	12	16	0
120200	12:02:00	12	2	0
140400	14:04:00	14	4	0
144300	14:43:00	14	43	0
153700	15:37:00	15	37	0
133800	13:38:00	13	38	0
142500	14:25:00	14	25	0
410	20260723	144300	164200	142	11	\N	119	1	f	f
411	20260723	120400	135800	143	122	\N	114	1	f	f
412	20260723	135800	154500	143	10	\N	107	1	f	f
413	20260723	132100	144200	144	9	\N	81	1	f	f
414	20260723	144200	155100	144	8	\N	69	1	f	f
415	20260723	130500	135500	145	121	\N	50	1	f	f
416	20260723	135500	152500	145	7	\N	90	1	f	f
417	20260723	152500	170000	145	6	\N	95	1	f	f
418	20260723	132500	153500	146	5	\N	130	1	f	f
419	20260723	122000	140500	147	4	\N	105	1	f	f
420	20260723	140500	160000	147	3	\N	115	1	f	f
421	20260723	132500	150500	148	2	\N	100	1	f	f
422	20260723	150500	170000	148	1	\N	115	1	f	f
\.
...
-- Dependencies: 229
-- Name: dim_channel_channel_key_seq; Type: SEQUENCE SET; Schema: warehouse; Owner: postgres
--

SELECT pg_catalog.setval('warehouse.dim_channel_channel_key_seq', 148, true);


--
-- TOC entry 5183 (class 0 OID 0)
-- Dependencies: 233
-- Name: dim_episode_episode_key_seq; Type: SEQUENCE SET; Schema: warehouse; Owner: postgres
--

SELECT pg_catalog.setval('warehouse.dim_episode_episode_key_seq', 175, true);


--
-- TOC entry 5184 (class 0 OID 0)
-- Dependencies: 235
-- Name: dim_genre_genre_key_seq; Type: SEQUENCE SET; Schema: warehouse; Owner: postgres
--

SELECT pg_catalog.setval('warehouse.dim_genre_genre_key_seq', 26, true);


--
-- TOC entry 5185 (class 0 OID 0)
-- Dependencies: 231
-- Name: dim_program_program_key_seq; Type: SEQUENCE SET; Schema: warehouse; Owner: postgres
--

SELECT pg_catalog.setval('warehouse.dim_program_program_key_seq', 276, true);


--
-- TOC entry 5186 (class 0 OID 0)
-- Dependencies: 238
-- Name: fact_broadcast_broadcast_key_seq; Type: SEQUENCE SET; Schema: warehouse; Owner: postgres
--

SELECT pg_catalog.setval('warehouse.fact_broadcast_broadcast_key_seq', 422, true);


--
-- TOC entry 4955 (class 2606 OID 18097)
...
--
-- TOC entry 4950 (class 2606 OID 18074)
...
--
-- TOC entry 4944 (class 2606 OID 18045)
...
--
-- TOC entry 4946 (class 2606 OID 18043)
...
--
-- TOC entry 4948 (class 2606 OID 18052)
...
--
-- TOC entry 4931 (class 2606 OID 18005)
...
--
-- TOC entry 4933 (class 2606 OID 18007)
...
--
-- TOC entry 4935 (class 2606 OID 18017)
...
--
-- TOC entry 4937 (class 2606 OID 18015)
...
--
-- TOC entry 4940 (class 2606 OID 18028)
...
--
-- TOC entry 4953 (class 2606 OID 18076)
...
--
-- TOC entry 4942 (class 2606 OID 18030)
...
--
-- TOC entry 4959 (class 2606 OID 18099)
...
--
-- TOC entry 4985 (class 2606 OID 18205)
-- Name: bridge_program_genre bridge_program_genre_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.bridge_program_genre
    ADD CONSTRAINT bridge_program_genre_pkey PRIMARY KEY (program_key, genre_key);


--
-- TOC entry 4969 (class 2606 OID 18157)
-- Name: dim_channel dim_channel_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_channel
    ADD CONSTRAINT dim_channel_pkey PRIMARY KEY (channel_key);


--
-- TOC entry 4971 (class 2606 OID 18159)
-- Name: dim_channel dim_channel_source_channel_id_key; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_channel
    ADD CONSTRAINT dim_channel_source_channel_id_key UNIQUE (source_channel_id);


--
-- TOC entry 4961 (class 2606 OID 18136)
...
--
-- TOC entry 4963 (class 2606 OID 18134)
...
--
-- TOC entry 4977 (class 2606 OID 18185)
-- Name: dim_episode dim_episode_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_episode
    ADD CONSTRAINT dim_episode_pkey PRIMARY KEY (episode_key);


--
-- TOC entry 4979 (class 2606 OID 18187)
-- Name: dim_episode dim_episode_source_episode_id_key; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_episode
    ADD CONSTRAINT dim_episode_source_episode_id_key UNIQUE (source_episode_id);


--
-- TOC entry 4981 (class 2606 OID 18196)
-- Name: dim_genre dim_genre_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_genre
    ADD CONSTRAINT dim_genre_pkey PRIMARY KEY (genre_key);


--
-- TOC entry 4983 (class 2606 OID 18198)
-- Name: dim_genre dim_genre_source_genre_id_key; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_genre
    ADD CONSTRAINT dim_genre_source_genre_id_key UNIQUE (source_genre_id);


--
-- TOC entry 4973 (class 2606 OID 18171)
-- Name: dim_program dim_program_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_program
    ADD CONSTRAINT dim_program_pkey PRIMARY KEY (program_key);


--
-- TOC entry 4975 (class 2606 OID 18173)
-- Name: dim_program dim_program_source_program_id_key; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_program
    ADD CONSTRAINT dim_program_source_program_id_key UNIQUE (source_program_id);


--
-- TOC entry 4965 (class 2606 OID 18148)
-- Name: dim_time dim_time_full_time_key; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.dim_time
    ADD CONSTRAINT dim_time_full_time_key UNIQUE (full_time);


--
-- TOC entry 4967 (class 2606 OID 18146)
-- Name: dim_time dim_time_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--
...
--
-- TOC entry 4987 (class 2606 OID 18234)
-- Name: fact_broadcast fact_broadcast_pkey; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_pkey PRIMARY KEY (broadcast_key);


--
-- TOC entry 4992 (class 2606 OID 18236)
-- Name: fact_broadcast uq_fact_broadcast; Type: CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT uq_fact_broadcast UNIQUE (channel_key, date_key, start_time_key);


--
-- TOC entry 4951 (class 1259 OID 18116)
...
--
-- TOC entry 4956 (class 1259 OID 18118)
...
--
-- TOC entry 4957 (class 1259 OID 18117)
...
--
-- TOC entry 4938 (class 1259 OID 18115)
...
--
-- TOC entry 4988 (class 1259 OID 18268)
-- Name: idx_fact_broadcast_channel; Type: INDEX; Schema: warehouse; Owner: postgres
--

CREATE INDEX idx_fact_broadcast_channel ON warehouse.fact_broadcast USING btree (channel_key);


--
-- TOC entry 4989 (class 1259 OID 18267)
-- Name: idx_fact_broadcast_date; Type: INDEX; Schema: warehouse; Owner: postgres
--

CREATE INDEX idx_fact_broadcast_date ON warehouse.fact_broadcast USING btree (date_key);


--
-- TOC entry 4990 (class 1259 OID 18269)
-- Name: idx_fact_broadcast_program; Type: INDEX; Schema: warehouse; Owner: postgres
--

CREATE INDEX idx_fact_broadcast_program ON warehouse.fact_broadcast USING btree (program_key);


--
-- TOC entry 5008 (class 2620 OID 18120)
...
--
-- TOC entry 5009 (class 2620 OID 18119)
...
--
-- TOC entry 4996 (class 2606 OID 18077)
...
--
-- TOC entry 4994 (class 2606 OID 18058)
...
--
-- TOC entry 4995 (class 2606 OID 18053)
...
--
-- TOC entry 4993 (class 2606 OID 18031)
...
--
-- TOC entry 4997 (class 2606 OID 18100)
...
--
-- TOC entry 4998 (class 2606 OID 18110)
...
--
-- TOC entry 4999 (class 2606 OID 18105)
...
--
-- TOC entry 5000 (class 2606 OID 18211)
-- Name: bridge_program_genre bridge_program_genre_genre_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.bridge_program_genre
    ADD CONSTRAINT bridge_program_genre_genre_key_fkey FOREIGN KEY (genre_key) REFERENCES warehouse.dim_genre(genre_key);


--
-- TOC entry 5001 (class 2606 OID 18206)
-- Name: bridge_program_genre bridge_program_genre_program_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.bridge_program_genre
    ADD CONSTRAINT bridge_program_genre_program_key_fkey FOREIGN KEY (program_key) REFERENCES warehouse.dim_program(program_key);


--
-- TOC entry 5002 (class 2606 OID 18252)
-- Name: fact_broadcast fact_broadcast_channel_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_channel_key_fkey FOREIGN KEY (channel_key) REFERENCES warehouse.dim_channel(channel_key);


--
-- TOC entry 5003 (class 2606 OID 18237)
-- Name: fact_broadcast fact_broadcast_date_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_date_key_fkey FOREIGN KEY (date_key) REFERENCES warehouse.dim_date(date_key);


--
-- TOC entry 5004 (class 2606 OID 18247)
-- Name: fact_broadcast fact_broadcast_end_time_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_end_time_key_fkey FOREIGN KEY (end_time_key) REFERENCES warehouse.dim_time(time_key);


--
-- TOC entry 5005 (class 2606 OID 18262)
-- Name: fact_broadcast fact_broadcast_episode_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_episode_key_fkey FOREIGN KEY (episode_key) REFERENCES warehouse.dim_episode(episode_key);


--
-- TOC entry 5006 (class 2606 OID 18257)
-- Name: fact_broadcast fact_broadcast_program_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_program_key_fkey FOREIGN KEY (program_key) REFERENCES warehouse.dim_program(program_key);


--
-- TOC entry 5007 (class 2606 OID 18242)
-- Name: fact_broadcast fact_broadcast_start_time_key_fkey; Type: FK CONSTRAINT; Schema: warehouse; Owner: postgres
--

ALTER TABLE ONLY warehouse.fact_broadcast
    ADD CONSTRAINT fact_broadcast_start_time_key_fkey FOREIGN KEY (start_time_key) REFERENCES warehouse.dim_time(time_key);


-- Completed on 2026-07-23 15:02:32

--
-- PostgreSQL database dump complete
--

\unrestrict uzrm2BdCnc74nuRJGVOOqYHXlgftPYWRRKOa7jIg9glNWBjWpQPg9czVgQauQpP
